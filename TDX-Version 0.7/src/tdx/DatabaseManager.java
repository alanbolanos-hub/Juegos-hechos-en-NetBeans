...
public class DatabaseManager {
    ...
    public boolean tryConnect() {
        try {
            ...
            System.err.println("[DB] Driver MySQL no encontrado. Agrega mysql-connector-j.jar al classpath.");
            connected = false;
    ...
    private void initSchema() throws SQLException {
        ...
        if (rs.getInt(1) == 0) {
            ...
            ps.executeUpdate();
            System.out.println("[DB] Admin por defecto: usuario=admin / contraseña=admin123");
        }
        st.close();
    }
